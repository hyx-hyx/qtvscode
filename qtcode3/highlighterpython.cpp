    ...
    : QSyntaxHighlighter(parent)
{
    ...
    keywordPatterns << "\\bdef\\b" << "\\bclass\\b" << "\\binput\\b"
                    << "\\benum\\b"<< "\\binline\\b" << "\\bint\\b"
                    << "\\blong\\b"<< "\\bprotected\\b"<< "\\bshort\\b"
                    << "\\isinstance\\b" << "\\bissubclass\\b"<< "\\bipdb\\b" << "\\bimport\\b" << "\\iter\\b"
                    << "\\bImportError\\b" << "\\bvolatile\\b" << "\\bbool\\b"<<"\\busing\\b"<<"\\bconstexpr\\b"
                    <<"\\bImportWarning\\b"<<"\\bif\\b"<<"\\bfor\\b"<<"\\bforeach\\b"<<"\\bwhile\\b"<<"\\bdo\\b"<<"\\bcase\\b"
